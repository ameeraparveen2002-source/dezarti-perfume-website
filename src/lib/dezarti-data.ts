...
const categoryImages: Record<Product["category"], string[]> = {
  ...
  women: [
    ...
    "/campaign/women/dezarti-women-page-37.png",
...
const perfumeProfiles: Record<number, PerfumeProfile> = {
  ...
  37: { name: "NEW YORK DREAM", notes: { top: ["Calabrian Bergamot", "Citron", "Sicilian Orange"], heart: ["Ceylon Cinnamon", "Nigerian Ginger", "Tunisian Neroli"], base: ["Ambroxan", "Chinese Black Tea", "Guaiac Wood", "Olibanum"] } },
